...
MMI.fitted_params(model::Union{KMeansClusterer,KMedoidsClusterer}, fitresult) = (centers=fitresult[2], cluster_labels=CategoricalArrays.categorical(fitresults[1]))
